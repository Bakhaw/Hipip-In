...
function DropdownButton({ isDropdownOpen, selectedDropdownItem, text, toggleDropdown }) {
  ...
  return (
    <button
      ...
      style={
        isDropdownOpen ? buttonHeaderStyle.dropdownOpen : buttonHeaderStyle.dropdownClose
      }
    ...
    >
      ...
      <img alt='Flèche vers le bas' className='Dropdown__header__chevron' src={chevron} />
    </button>
  );
}
